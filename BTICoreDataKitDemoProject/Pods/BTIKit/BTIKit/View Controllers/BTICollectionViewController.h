...
@property (nullable, nonatomic, strong) IBOutlet UICollectionView *collectionView;
 ...
 */
- (nullable id)itemInCollectionView:(nonnull UICollectionView *)collectionView atIndexPath:(nullable NSIndexPath *)indexPath;
