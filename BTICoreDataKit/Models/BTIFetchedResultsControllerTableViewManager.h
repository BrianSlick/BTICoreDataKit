...
/*
 ...
 It is very rare that NSFetchedResultsControllerDelegate methods need to be customized. This means copy-pasting a lot of code that winds up being the same in all kinds of places.  The purpose of this class is to remove the need to do so.  This class becomes the delegate of the supplied FRC, and then takes care of updating the supplied table view.
 
 The intended use is to create an instance of this class, feed it a FRC and a table view, then stick it into a property. It should run on automatic after that.
...
@interface BTIFetchedResultsControllerTableViewManager : BTIObject
...
/// A table view to manage. This class will update the table view in response to FRC changes.
